...
//ouvrir et fermer le formulaire d'ajout de travailleur
document.getElementById("btnAddTra").addEventListener("click", () =>{
    document.getElementById("addTraModal").style.display = "flex";
});
//Fermer modal Travailleur
function closeAddTraModal(){
    document.getElementById("addTraModal").style.display = "none";
}
...
// fermer  le modal s clic dehors
window.onclick = function(event){
  const modalT = document.getElementById("addTraModal");
